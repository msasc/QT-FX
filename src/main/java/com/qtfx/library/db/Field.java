...
public class Field implements Comparable<Object> {
	...
	/** Horizontal position. */
	private static final Integer HORIZONTAL_POSITION = index++;
	/** Vertical position. */
	private static final Integer VERTICAL_POSITION = index++;
	...
	/**
	 * Check if this field value should be initialized to the current date, time or time stamp.
	 *
	...
	/**
	 * Set if this field value should be initialized to the current date, time or time stamp.
	 *
	...
	public HPos getHorizontalPosition() {
		return (HPos) properties.getObject(HORIZONTAL_POSITION, HPos.LEFT);
	}
	 ...
	 */
	public void setHorizontalPosition(HPos horizontalPosition) {
		if (horizontalPosition == null) {
			horizontalPosition = HPos.LEFT;
		}
		properties.setObject(HORIZONTAL_POSITION, horizontalPosition);
	}
	...
	public VPos getVerticalPosition() {
		return (VPos) properties.getObject(VERTICAL_POSITION, VPos.CENTER);
	}
	 ...
	 */
	public void setVerticalPosition(VPos verticalPosition) {
		if (verticalPosition == null) {
			verticalPosition = VPos.CENTER;
		}
		properties.setObject(VERTICAL_POSITION, verticalPosition);
	}
	...
	/**
	 * Gets the tool tip text for this field.
	 * 
	 * @return a String.
	 */
	...
	/**
	 * Check if edition is upper case. 
	 *
	 * @return A boolean
	 */
	...
	/**
	 * Returns a boolean indicating if seconds should be edited when the type is time or time-stamp.
	 * 
	 * @return A boolean indicating if seconds should be edited when the type is time or time-stamp.
	 */
	...
	/**
	 * Sets a boolean indicating if seconds should be edited when the type is time or time-stamp.
	 * 
	 * @param editSeconds A boolean indicating if seconds should be edited when the type is time or time-stamp.
	 */
	...
	/**
	 * Returns the optional action lookup or null.
	 * 
	 * @return The optional action lookup or null.
	 */
