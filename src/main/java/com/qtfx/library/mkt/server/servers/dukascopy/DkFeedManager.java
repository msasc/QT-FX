...
import com.qtfx.library.mkt.server.servers.dukascopy.listeners.DkBarFeedListener;
...
public class DkFeedManager implements FeedManager {
	...
	private Set<Instrument> getDkInstruments(FeedListener listener) {
		ArrayList<com.qtfx.library.mkt.data.Instrument> instruments = new ArrayList<>();
		...
		for (com.qtfx.library.mkt.data.Instrument instrument : instruments) {
