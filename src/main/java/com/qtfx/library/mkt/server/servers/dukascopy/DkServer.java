 ...
 */
package com.qtfx.library.mkt.server.servers.dukascopy;
...
import com.qtfx.library.mkt.server.AccountType;
import com.qtfx.library.mkt.server.ConnectionManager;
import com.qtfx.library.mkt.server.FeedManager;
import com.qtfx.library.mkt.server.HistoryManager;
import com.qtfx.library.mkt.server.OrderManager;
import com.qtfx.library.mkt.server.ServerException;
import com.qtfx.library.mkt.server.servers.AbstractServer;
import com.qtfx.library.mkt.server.servers.dukascopy.listeners.DkStrategyListener;
import com.qtfx.library.mkt.server.servers.dukascopy.listeners.DkSystemListener;
...
public class DkServer extends AbstractServer {
	...
	public List<Instrument> getAvailableInstruments() {
		...
		for (com.dukascopy.api.Instrument dukascopyInstrument : dukascopyInstruments) {
			Instrument instrument = getDkConverter().fromDkInstrument(dukascopyInstrument);
