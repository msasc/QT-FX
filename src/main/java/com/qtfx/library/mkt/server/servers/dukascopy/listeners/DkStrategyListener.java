...
import com.qtfx.library.mkt.server.feed.FeedListener;
import com.qtfx.library.mkt.server.feed.TickSubscription;
import com.qtfx.library.mkt.server.servers.dukascopy.DkFeedDispatcher;
...
public class DkStrategyListener implements IStrategy {
	 ...
	 * @throws JFException If an error occurs.
	 */
