 ...
 */
package com.qtfx.library.mkt.server.servers.dukascopy.listeners;

import com.dukascopy.api.Instrument;
import com.dukascopy.api.OfferSide;
import com.dukascopy.api.Period;
import com.qtfx.library.mkt.server.feed.DataSubscription;
import com.qtfx.library.mkt.server.feed.FeedListenerAdapter;
import com.qtfx.library.mkt.server.feed.TickSubscription;
import com.qtfx.library.mkt.server.servers.dukascopy.DkServer;
...
public class DkFeedListener extends FeedListenerAdapter {
	...
	public void addCurrentDataSubscription(Instrument dkInstrument, Period dkPeriod, OfferSide dkOfferSide) {
		com.qtfx.library.mkt.data.Instrument instrument = server.getDkConverter().fromDkInstrument(dkInstrument);
		com.qtfx.library.mkt.data.Period period = server.getDkConverter().fromDkPeriod(dkPeriod);
		com.qtfx.library.mkt.server.OfferSide offerSide = server.getDkConverter().fromDkOfferSide(dkOfferSide);
