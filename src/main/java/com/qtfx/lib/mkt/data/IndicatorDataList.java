...
public class IndicatorDataList extends DataList {
	 ...
	 */
	public IndicatorDataList(Indicator indicator, List<IndicatorSource> indicatorSources) {
		super(indicator.getIndicatorInfo());
	...
	public boolean equals(Object obj) {
		if (obj instanceof IndicatorDataList) {
			...
			if (!Lists.equals(getIndicatorSources(), idl.getIndicatorSources())) {
				return false;
			}
