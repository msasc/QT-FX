...
public class NumberImageUtils {
	...
	public static final String TEST_LABELS = "resources/mnist/t10k-labels.idx1-ubyte";
	/** Check images file name. */
	public static final String TEST_IMAGES = "resources/mnist/t10k-images.idx3-ubyte";
	/** Learn labels file name. */
	public static final String TRAIN_LABELS = "resources/mnist/train-labels.idx1-ubyte";
	/** Learn images file name. */
	public static final String TRAIN_IMAGES = "resources/mnist/train-images.idx3-ubyte";
