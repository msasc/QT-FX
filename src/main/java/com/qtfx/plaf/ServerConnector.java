...
public class ServerConnector {
	...
	public static void connect(Node node) throws ServerException {
	...
	public static void disconnect(Node node) throws ServerException {
		Server server = QTFX.getServer(node);
		server.getConnectionManager().disconnect();
	}

	public static boolean isConnected(Node node) throws ServerException {
		Server server = QTFX.getServer(node);
