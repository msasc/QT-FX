 ...
 */
package com.qtfx.library.database;
...
public class Field implements Comparable<Object> {
	...
	/**
	 * Returns a boolean indicating if secnds should be edited when the type is time or time-stamp.
	 * 
	 * @return A boolean indicating if secnds should be edited when the type is time or time-stamp.
	 */
	...
	/**
	 * Sets a boolean indicating if secnds should be edited when the type is time or time-stamp.
	 * 
	 * @param editSeconds A boolean indicating if secnds should be edited when the type is time or time-stamp.
	 */
