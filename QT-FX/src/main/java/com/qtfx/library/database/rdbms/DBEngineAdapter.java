 ...
 */
package com.qtfx.library.database.rdbms;
...
import com.qtfx.library.database.Criteria;
import com.qtfx.library.database.Field;
import com.qtfx.library.database.Filter;
import com.qtfx.library.database.ForeignKey;
import com.qtfx.library.database.Index;
import com.qtfx.library.database.Record;
import com.qtfx.library.database.Table;
import com.qtfx.library.database.Value;
import com.qtfx.library.database.ValueMap;
import com.qtfx.library.database.View;
import com.qtfx.library.database.rdbms.sql.AddCheck;
import com.qtfx.library.database.rdbms.sql.AddField;
import com.qtfx.library.database.rdbms.sql.AddForeignKey;
import com.qtfx.library.database.rdbms.sql.AddPrimaryKey;
import com.qtfx.library.database.rdbms.sql.CreateIndex;
import com.qtfx.library.database.rdbms.sql.CreateSchema;
import com.qtfx.library.database.rdbms.sql.CreateTable;
import com.qtfx.library.database.rdbms.sql.Delete;
import com.qtfx.library.database.rdbms.sql.DropConstraint;
import com.qtfx.library.database.rdbms.sql.DropField;
import com.qtfx.library.database.rdbms.sql.DropForeignKey;
import com.qtfx.library.database.rdbms.sql.DropIndex;
import com.qtfx.library.database.rdbms.sql.DropPrimaryKey;
import com.qtfx.library.database.rdbms.sql.DropSchema;
import com.qtfx.library.database.rdbms.sql.DropTable;
import com.qtfx.library.database.rdbms.sql.Insert;
import com.qtfx.library.database.rdbms.sql.Select;
import com.qtfx.library.database.rdbms.sql.Update;
...
public abstract class DBEngineAdapter {
	 ...
	 * @throws SQLException If such an exception occurs.
	 */
