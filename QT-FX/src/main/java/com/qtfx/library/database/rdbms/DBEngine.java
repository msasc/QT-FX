...
import com.qtfx.library.database.OrderKey;
import com.qtfx.library.database.Record;
import com.qtfx.library.database.RecordIterator;
import com.qtfx.library.database.RecordSet;
...
import com.qtfx.library.database.rdbms.sql.Statement;
...
public class DBEngine {
	...
	public Cursor executeSelectCursor(Select select, Connection cn) throws SQLException {
		return executeSelectCursor(select, false, cn);
	}
